...
class FilterPageResidential extends StatefulWidget {
  const FilterPageResidential({Key? key}) : super(key: key);

  @override
  _FilterPageResidentialState createState() => _FilterPageResidentialState();
}

class _FilterPageResidentialState extends State<FilterPageResidential> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
               ...
               TitleWidget(title: "bedrooms".tr()),
               const MaxMinBoxes(),

               TitleWidget(title: "bathroom".tr()),
               const MaxMinBoxes(),

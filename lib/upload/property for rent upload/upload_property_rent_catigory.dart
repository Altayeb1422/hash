...
import 'package:hash/upload/property%20for%20rent%20upload/upload_proprty_for_rent_types.dart';
import '../../model/child.dart';
import '../../services/child_remote_services.dart';
import '../../widget/filters_card_widget.dart';

class UploadPropertyForRentCatigory extends StatefulWidget {
  const UploadPropertyForRentCatigory({Key? key, this.select1, this.select1Name}) : super(key: key);
  final dynamic select1;
  final dynamic select1Name;
  @override
  _UploadPropertyForRentCatigoryState createState() =>
                ...
                return CardWidget(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => UploadPropertyForRentTypes(

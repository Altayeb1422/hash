...
Future uploadMultipleImages(File img,) async {
  ...
  var uri = Uri.parse("http://192.168.15.116/easy/upload_property_images.php?Ads_Id="+adsId.toString()+"&Client_ID="+89.toString()); //sending post request with header data

...
class ChildRemoteService
{
  ...
  Future postParentId(id) async {
    ...
    var res = await client.get(Uri.parse("http://192.168.15.122/easy/Childs.php?parentId="+id),);
  ...
  {
    var client = http.Client();
    var response = await client.get(Uri.parse("http://192.168.15.122/easy/Childs.php"),);
